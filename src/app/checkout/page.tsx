  ...
  return (
    <div>
      ...
      <div className="p-4 h-fit flex flex-col">
        <Typography variant="h1" className="text-center text-5xl font-normal mb-8">
          Checkout
        </Typography>
          ...
          <TabsList className="flex justify-center gap-x-6 bg-white">
            <TabsTrigger
              ...
              className={`text-lg pb-2 border-b-2 rounded-none ${
                currentTab === "summary" ? "border-black font-semibold" : "border-transparent text-gray-500"
              }`}
            ...
            <TabsTrigger
              value="complete"
              className={`text-lg pb-2 border-b-2 rounded-none ${
                currentTab === "complete" ? "border-black font-semibold" : "border-transparent text-gray-500"
              }`}
